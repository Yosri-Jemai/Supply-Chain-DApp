...
contract Tracking {
    ...
    function createShipment(
        ...
        require(
            msg.value >= _price,
            "Insufficient payment for shipment"
        );
    ...
    function startShipment(
        ...
        shipment.status = ShipmentStatus.IN_TRANSITION;
        typeShipment.status = ShipmentStatus.IN_TRANSITION;

        emit ShipmentInTransition(
            _sender,
            shipment.receiver,
            shipment.pickupTime
        );
